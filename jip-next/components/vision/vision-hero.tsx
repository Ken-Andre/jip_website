        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-purple-light/30 to-background py-20">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <h1 className="mb-6 font-serif text-4xl font-bold text-foreground sm:text-5xl">{t("vision.hero.title")}</h1>
                    <p className="text-lg text-muted-foreground">{t("vision.hero.subtitle")}</p>
                </div>
            </div>
        </section>
    )
