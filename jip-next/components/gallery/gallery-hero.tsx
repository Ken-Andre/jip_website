            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-1.5">
                        ...
                        <span className="text-sm font-medium text-gold">JIP</span>
                    </div>
                    <h1 className="mb-6 font-serif text-4xl font-bold text-foreground sm:text-5xl">{t("gallery.hero.title")}</h1>
                    <p className="text-lg text-muted-foreground">{t("gallery.hero.subtitle")}</p>
                </div>
            </div>
        </section>
    )
