...
1. WHEN le site charge THEN affiche sélecteur langue (FR/EN) intégré à Starlight
...
- i18n: Starlight natif (content collections + i18nLoader)
- Configuration: `src/content.config.ts` avec i18n collection
- Fichiers: `src/content/i18n/fr.json`, `src/content/i18n/en.json`
- Traduction: Google Translate ou prof (à valider)
- Routing: Starlight auto (/fr/, /en/)
